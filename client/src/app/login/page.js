            ...
            <div className='card p-4 shadow-lg text-center' style={{ maxWidth: "500px", width: "100%" }}>
                ...
                <form>
                    ...
                    <div className="d-flex justify-content-between">
                        <Link href={"/Register"} className='text-decoration-none text-light'>Create Account</Link>
                        <Link href={"/forget-password"} className='text-decoration-none text-light'>Forget password?</Link>
                    </div>
                </form>
            </div >
        </div >
